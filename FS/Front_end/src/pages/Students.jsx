  ...
  return (
    <div>
      ...
      <p className="page-subtitle">
        Daftar seluruh siswa beserta status risiko
      </p>
              ...
              <tbody>
                {filteredStudents.map((s, i) => (
                  <tr key={i}>
                    ...
                    <td>{s.score ?? '-'}</td>
                    <td>
                      {resultBadge(s.final_result)}
                    </td>
                    <td>
                      {riskBadge(s.risk_label)}
                    </td>
                  </tr>
                ))}
              </tbody>
